...
Content Navigator is a Streamlit-based web application that leverages **RAG**, integrating semantic and keyword-based search for efficient information retrieval. It utilizes **Whoosh** for keyword-based search and **Chroma** for vector-based semantic search, combined with **OpenAI's GPT-4o** for generative response generation. The system processes **PDF and HTML webpages**, enabling users to extract meaningful insights through real-time queries.
